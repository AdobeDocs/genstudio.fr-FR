---
title: Révisions et approbations GenStudio
description: Découvrez le processus de révision et d’approbation de GenStudio.
feature: Approval
...
# Révisions et approbations GenStudio

Le processus de révision et d’approbation de GenStudio permet à toutes les parties prenantes (des équipes créatives aux experts juridiques) de passer en revue et d’approuver efficacement les composants de campagne, y compris les ressources de marque générées par l’IA.
...
Lorsqu’un brouillon termine le processus de révision et d’approbation et est publié sur [!DNL Content], l’ID de brouillon expire et GenStudio n’enregistre pas les commentaires et les états d’approbation associés. L’URL du brouillon n’est plus valide.
