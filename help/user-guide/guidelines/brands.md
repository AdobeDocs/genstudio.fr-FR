...
Vous pouvez charger des documents d’orientation de marque (jusqu’à trois fichiers DOC ou PDF) vers GenStudio for Performance Marketing afin de créer automatiquement une marque. Voir [Ajout de directives](add-guidelines.md) pour savoir comment ajouter une marque à GenStudio for Performance Marketing, la modifier, la publier, etc.
