...
description: Ajoutez  [!DNL Brands], [!DNL Products], and [!DNL Personas]  à GenStudio pour les marketeurs de performance afin de créer un profil de marque complet qui comprend tous les aspects de la représentation d’une marque.
...
Instructions de GenStudio pour les spécialistes du marketing des performances :
...
En intégrant des données de marque, de produit et de personnage dans GenStudio pour les marketeurs de performance, vous pouvez améliorer la qualité du contenu généré par l’IA, en assurant une identité de marque complète et personnalisée.
...
En collaboration avec la fonctionnalité d’IA générative de l’Adobe, [!DNL Brands], [!DNL Products] et [!DNL Personas] jouent un rôle essentiel pour s’assurer que tout le contenu de GenStudio for Performance Marketing s’aligne sur votre identité de marque.
