...
description: Découvrez comment créer des expériences de courrier électronique dans Adobe GenStudio for Performance Marketing.
...
Pour créer une expérience d’e-mail efficace, il est recommandé d’[ajouter des instructions à GenStudio for Performance Marketing](/help/user-guide/guidelines/add-guidelines.md) et de détailler les [ principes de base de création d’une invite](/help/user-guide/effective-prompts.md) avant de commencer.
